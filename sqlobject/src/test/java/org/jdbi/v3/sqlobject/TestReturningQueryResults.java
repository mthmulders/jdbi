...
public class TestReturningQueryResults
{
    ...
    public void testIterator() throws Exception
    {
        ...
        db.getJdbi().useExtension(Spiffy.class, spiffy -> {
            ...
            assertThat(itty).hasSize(2).containsOnly(new Something(7, "Tim"), new Something(3, "Diego"));
        });
    }
    ...
    public void testList() throws Exception
    {
        ...
        db.getJdbi().useExtension(Spiffy.class, spiffy -> {
            ...
            assertThat(all).hasSize(2).containsOnly(new Something(7, "Tim"), new Something(3, "Diego"));
        });
    }
